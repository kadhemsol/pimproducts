...
<?= $this->section('main') ?>
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Ajouter un nouveau produit</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<a href="#" class="btn btn-sm fw-bold btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Ajouter</a>
										<!--end::Primary button-->
									</div>
									<!--end::Actions-->
								</div>
										...
										<div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
											...
											<div class="card card-flush py-4">
												...
												<div class="card-body pt-0">
													<!--begin::Select2-->
													<select name= "state" class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_product_status_select">
														<option></option>
														<option value="published" selected="selected">Publier</option>
													...
													<div class="d-none mt-10">
														<label for="kt_ecommerce_add_product_status_datepicker" class="form-label">Sélectionnez la date et l'heure de publication</label>
											...
											<div class="card card-flush py-4">
												...
												<div class="card-body pt-0">
													...
													<!--end::Svg Icon-->Créer une nouvelle catégorie</a>
													<!--end::Button-->
													<!--begin::Input group-->
													<!--begin::Label-->
													...
													<!--end::Input-->
													<!--begin::Description-->
													<div class="text-muted fs-7">Ajouter des balises à un produit.</div>
													<!--end::Description-->
													<!--end::Input group-->
												</div>
												<!--end::Card body-->
														...
														<div class="card card-flush py-4">
															...
															<div class="card-body pt-0">
																...
																<div>
																	...
																	<!--end::Label-->
																	<!--begin::Editor-->
																	<div id="product_description" name="description" class="min-h-200px mb-2"></div>
																	<!--end::Editor-->
																	<!--begin::Description-->
																	...
																	<div id="kt_ecommerce_add_product_meta_description" name="short_description" class="min-h-100px mb-2"></div>
																	<!--end::Editor-->
																	<!--begin::Description-->
																	<div class="text-muted fs-7">Attribuez une description courte au produit </div>
																	<!--end::Description-->
																</div>
														...
														<div class="card card-flush py-4">
															...
															<div class="card-body pt-0">
																...
																<div class="mb-10 fv-row">
																		...
																		<label class="fs-6 fw-semibold mb-2">Type de produit
																	...
																	<select class="form-select mb-2" name="Type" data-control="select2" data-hide-search="true" data-placeholder="Select an option">
																			<option></option>
																			<option value="0">Produit simple</option>
																			<option value="1">Product bundle</option>
																	...
																	<input type="text" name="price" class="form-control mb-2" placeholder="Prix régulier" value="" />
																	<input type="text" name="price2" class="form-control mb-2" placeholder="Prix promotionnel" value="" />
																	<input type="text" name="promo" class="form-control mb-2" placeholder="En promo ?" value="" />
																	<input type="text" name="inventory_m" class="form-control mb-2" placeholder="Stock Managé" value="" />
																	<input type="text" name="inventory" class="form-control mb-2" placeholder="Quantité en stock" value="" />
																	<input type="text" name="sku" class="form-control mb-2" placeholder="Autoriser les commandes en réapprovisionnement ?" value="" />
																	<input type="text" name="low_inventory" class="form-control mb-2" placeholder="Seuil de stock faible" value="" />
																	<input type="text" name="inventory_min" class="form-control mb-2" placeholder="Minimum Quantity" value="" />
																	<input type="text" name="inventory_max" class="form-control mb-2" placeholder="Maximum Quantity" value="" />
																	<input type="text" name="Visibility" class="form-control mb-2" placeholder="Visibilité du catalogue" value="" />
																	<input type="text" name="suggested_price" class="form-control mb-2" placeholder="Prix conseillé" value="" />
																	<input type="text" name="buying_price" class="form-control mb-2" placeholder="Prix d'achat" value="" />
	...
	<div class="mb-10 fv-row">
																...
																<select class="form-select mb-2" name="tax" data-control="select2" data-hide-search="true" data-placeholder="Select an option">
																			<option >Ajouter un attribut</option>
																			><option value="">Ajouter un attribut</option><option value="23">Capacité (cigares)</option><option value="29">Contenance (Centilitre)</option><option value="31">Couleur</option><option value="25">Domaine</option><option value="33">Flamme</option><option value="7">Goût</option><option value="21">Hauteur (cm)</option><option value="20">Largeur (cm)</option><option value="22">Longueur (cm)</option><option value="37">Manche</option><option value="32">Matériau</option><option value="24">Millésime</option><option value="30">Packaging</option><option value="5">Pays / Terroir</option><option value="4">Quantité</option><option value="36">Style</option><option value="28">Taux d'Alcool %</option><option value="34">Type de coupe(s)</option><option value="26">Type de Spiritueux</option>
													...
													<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
																...
																<div class="mb-10 fv-row">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="sku_f" class="form-control mb-1" placeholder="SKU Fournisseur" value="" />
																	<!--end::Input-->
																	<!--begin::Description-->
																	<input class="orm-control mb-2" type="checkbox" id="kt_ecommerce_add_product_shipping_checkbox" value="1">
																</div>
																</div>
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="sku" class="form-control mb-1" placeholder="Pays de Production" value="" />
																	<!--end::Input-->
																	<!--begin::Description-->
																	<input class="orm-control mb-2" type="checkbox" id="kt_ecommerce_add_product_shipping_checkbox" value="1">
																</div>
															...
															<div class="card-body pt-0">
																...
																<div id="kt_ecommerce_add_product_shipping" class="mt-10">
																	...
																	<div class="mb-10 fv-row">
																		...
																		<!--end::Label-->
																		<!--begin::Editor-->
																		<input type="text" name="weight" class="form-control mb-2" placeholder="Poids" value="" />
																		<!--end::Editor-->
																		<!--begin::Description-->
																		<div class="text-muted fs-7">Définir un poids de produit en kilogrammes (kg).</div>
																		<!--end::Description-->
																	</div>
																	<!--end::Input group-->
																	<!--begin::Input group-->
																	<div class="fv-row">
																		<!--begin::Label-->
																		<label class="form-label">Dimension (mm)</label>
																		<!--end::Label-->
																		<!--begin::Input-->
																		<div class="d-flex flex-wrap flex-sm-nowrap gap-3">
																			<input type="number" name="width" class="form-control mb-2" placeholder="Longueur" value="" />
																			<input type="number" name="height" class="form-control mb-2" placeholder="Hauteur" value="" />
																			<input type="number" name="length" class="form-control mb-2" placeholder="Largeur" value="" />
																		</div>
																		<!--end::Input-->
																		<!--begin::Description-->
																		<div class="text-muted fs-7">Entrez les dimensions du produit en (mm).</div>
																		<!--end::Description-->
																	</div>
																	<!--end::Input group-->
																</div>
